...
class _MapState extends State<MapScreen> {
  ...
  void sendMessage({
    ...
    FirebaseMessageService.sendMessage(
      title: 'Notice !!',
      content:
          '${user.name} is finding a way from ${startPre?.description!.contains('My Location') == false ? startPre?.description : 'Position of ${user.name}'} to ${endPre?.description!.contains('My Location') == false ? endPre?.description : 'Position of ${user.name}'}',
      data: {
        'fromPhoneToken':
